...
contract LazyCat is ERC20, Ownable {
    constructor()
        ERC20("LazyCat", "LAZYCAT")
        Ownable(0x14d1a0A6b7e9c3B382469AD15ecC4117e7411f64)
    {
        _mint(0x14d1a0A6b7e9c3B382469AD15ecC4117e7411f64, 1000000000 * 10 ** decimals());
    }
